...
export const SITE_NAME = process.env.NEXT_PUBLIC_SITE_NAME || 'Defend Freedom Industries';
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://defendfreedomindustries.com';
